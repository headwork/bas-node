...
| [05_신규_프로젝트_설정.md](05_신규_프로젝트_설정.md) | 새 프로젝트를 태울 때 모아야 할 값 · 조용히 실패하는 자리 |
| [06_배포_스크립트_규약.md](06_배포_스크립트_규약.md) | bat·sh 작성 규약 — 인코딩 · 줄바꿈 · 인자 · 종료코드. `npm test` 가 강제한다 |

새 프로젝트는 [deploy_sample.yaml](../template/deploy_sample.yaml) 을 복사해서 값만 바꾼다.
